          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:ml-4 md:flex md:shrink-0 md:items-center">
              ...
              <Menu as="div" className="relative ml-3">
                ...
                <MenuItems
                  transition
                  className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg outline-1 outline-black/5 transition data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
                >
