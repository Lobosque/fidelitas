      ...
      <div className="min-h-full">
        <header className="bg-indigo-600 pb-24">
            ...
            <div className="relative flex items-center justify-center py-5 lg:justify-between">
              ...
              <div className="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
                ...
                <Menu as="div" className="relative ml-4 shrink-0">
                  ...
                  <MenuItems
                    transition
                    className="absolute right-0 z-10 mt-2 -mr-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg outline outline-black/5 data-leave:transition data-leave:duration-75 data-leave:ease-in data-closed:data-leave:scale-95 data-closed:data-leave:transform data-closed:data-leave:opacity-0"
                  >
              ...
              <div className="min-w-0 flex-1 px-12 lg:hidden">
                <div className="mx-auto grid w-full max-w-xs grid-cols-1">
                  ...
                  <MagnifyingGlassIcon
                    aria-hidden="true"
                    className="pointer-events-none col-start-1 row-start-1 ml-3 size-5 self-center text-white/75"
                  />
                </div>
              </div>
          ...
          <Dialog open={open} onClose={setOpen} className="lg:hidden">
            ...
            >
              <div className="divide-y divide-gray-200 rounded-lg bg-white shadow-lg outline outline-black/5">
                  ...
                  <div className="flex items-center justify-between px-4">
                    ...
                    <div className="-mr-2">
                      <button
                        ...
                        className="relative inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-white"
                      >
                        <span className="absolute -inset-0.5" />
