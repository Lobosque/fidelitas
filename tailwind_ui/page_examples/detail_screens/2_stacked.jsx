            ...
            <div className="mx-auto flex max-w-2xl items-center justify-between gap-x-8 lg:mx-0 lg:max-w-none">
              <div className="flex items-center gap-x-6">
                <img
                  ...
                  className="size-16 flex-none rounded-full bg-gray-100 outline -outline-offset-1 outline-black/5"
                />
                <h1>
                    ...
                    {activityItem.type === 'commented' ? (
                      <>
                        <img
                          ...
                          className="relative mt-3 size-6 flex-none rounded-full bg-gray-100 outline -outline-offset-1 outline-black/5"
                        />
              ...
              <div className="mt-6 flex gap-x-3">
                ...
                <form action="#" className="relative flex-auto">
                  ...
                  <div className="absolute inset-x-0 bottom-0 flex justify-between py-2 pr-2 pl-3">
                      ...
                      <div className="flex items-center">
                        <Listbox value={selected} onChange={setSelected}>
                          ...
                          <div className="relative">
                            ...
                            <ListboxOptions
                              transition
                              className="absolute bottom-10 z-10 -ml-6 w-60 rounded-lg bg-white py-3 text-base shadow-sm outline-1 outline-black/5 data-leave:transition data-leave:duration-100 data-leave:ease-in data-closed:data-leave:opacity-0 sm:ml-auto sm:w-64 sm:text-sm"
                            >
                              {moods.map((mood) => (
                                <ListboxOption
                                  key={mood.value}
                                  value={mood}
                                  className="relative cursor-default bg-white px-3 py-2 text-gray-900 select-none data-focus:bg-gray-100"
                                >
                                  <div className="flex items-center">
                                    <div
                                      className={classNames(
                    ...
                    <button
                      type="submit"
                      className="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-xs inset-ring-1 inset-ring-gray-300 hover:bg-gray-50"
                    >
                      Comment
                    </button>
                  </div>
